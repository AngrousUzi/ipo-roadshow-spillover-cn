#!/usr/bin/env python3
"""
Variant: gaze_reduced
visual → 6 gaze/head cols only (drop gaze_x_mean, gaze_y_mean, head_frontal_ratio_10,
         head_yaw_mean).
visual_fer → base (3 ratios + emo_happy + emo_neutral + emo_sad).
All other groups identical to pca_combined_tui.py (base).
"""
